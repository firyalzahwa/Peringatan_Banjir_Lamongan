...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Tambah Data Desa</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
<section class="content">
    <div class="container-fluid">
        <form method="POST" action="{{route('admin.villages.store')}}">
            ...
            <div class="form-group">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6">
                        <input type="number" name="long_villages" class="form-control"/>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6">
                        <input type="number" name="lat_villages" class="form-control"/>
                    </div>
                </div>
