        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Edit Data Tinggi Permukaan Tanah</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="card card-info ml-4 mr-4 mt-4">
        <div class="card-header">
            <h3 class="card-title">Form Edit Data Tinggi Permukaan Tanah</h3>
        </div>
        
        <form class="form-horizontal" method="POST" action="{{route('admin.landheights.update', $landheight->id)}}">
            @method('PUT')
            <div class="card-body">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6">
                        <select type="text" name="village_id" class="form-control">
                            ...
                            <option value="{{ $v -> id}}" @if($v->id == $landheight->village_id)
                                selected
                                @endif
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            ...
                            placeholder="Tinggi Permukaan Tanah" value="{{ $landheight->total}}" />
                        </div>
                    </div>
