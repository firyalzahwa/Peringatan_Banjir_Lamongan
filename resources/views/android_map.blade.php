              ...
              <div class="col">
                <div class="form-group">
                  ...
                  <select class="form-control" id="select-pilih-peta">
                    <option @if($jenis=='Peta Rawan F AHP') selected @endif data-url="{{route('fahp')}}">Peta Rawan F AHP</option>
                    <option @if($jenis=='Peta Rawan AHP') selected @endif data-url="{{route('ahp')}}">Peta Rawan AHP</option>
                  </select>
                </div>
              </div>
            </div>         
